...
$config['assets_setting']	=	array	('full'	=>	array	(
								...
								'Creator'														     =>	array('asset_creator_name','asset_creator_affiliation','asset_creator_source',	'asset_creator_ref','asset_creator_role',	'asset_creator_role_source'),
								...
								'Audience'																		=>	array('asset_audience_level','asset_audience_level_source','asset_audience_level_ref','asset_audience_rating','asset_audience_rating_source','asset_audience_rating_ref'),
								'Annotation'																=>	array('asset_annotation','asset_annotation_type','asset_annotation_ref','asset_rights','asset_rights_link')),
							'simple'																				=>	array	(
