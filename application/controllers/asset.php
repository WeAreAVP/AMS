...
//debug($data['asset_detail']);
	...
	function insert_pbcore_values()
	{
		$static_gen = array("Clip reel",
			...
			"Composite masterpositive",
			"Composite negative",
			"Composite original negative",
			"Composite original positive",
			"Composite positive",
			"Composite reversal print",
			"Composite viewing print",
			...
			"Master: protection",
			"Masterpositive",
			"Masterpositive picture",
			"Masterpositive track",
			"Mix element",
