...
class Assets extends MY_Controller
{
	...
	{
		$asset_type = array('Subtitle', 'Supplied', 'Syllabus', 'Teacher\'s Guide', 'Test', 'Track', 'Trailer', 'Transcript', 'Translation',
			'Transmission','Version','Voice','Web page','Web site','Working');
