...
class Mediainfo extends CI_Controller {
    ...
    function process_dir() {
        ...
        $media_info_paths['audio'] = 'assets/mediainfo/audio/';
        $media_info_paths['video'] = 'assets/mediainfo/video/';
        foreach ($media_info_paths as $media_info_path) {
            $this->cron_model->scan_directory($media_info_path, $dir_files);
