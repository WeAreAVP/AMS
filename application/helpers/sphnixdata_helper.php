...
function make_assets_sphnix_array($row, $new = TRUE)
{
	...
	$data['s_guid_identifier'] = ! empty($row->guid_identifier) ? $row->guid_identifier : ''; //
	$data['guid_identifier'] = ! empty($row->guid_identifier) ? $row->guid_identifier : '';
	$data['s_description'] = ! empty($row->description) ? $row->description : ''; //
	...
	$data['s_local_identifier'] = ! empty($row->local_identifier) ? $row->local_identifier : ''; //
	...
	$data['s_asset_subject'] = ! empty($row->asset_subject) ? $row->asset_subject : ''; //
	...
	$data['s_asset_genre'] = ! empty($row->asset_genre) ? $row->asset_genre : ''; //
	...
	$data['s_asset_creator_name'] = ! empty($row->asset_creator_name) ? $row->asset_creator_name : ''; //
	...
	$data['s_asset_contributor_name'] = ! empty($row->asset_contributor_name) ? $row->asset_contributor_name : ''; //
	...
	$data['s_asset_publisher_name'] = ! empty($row->asset_publisher_name) ? $row->asset_publisher_name : ''; //
	...
	$data['s_asset_coverage'] = ! empty($row->asset_coverage) ? $row->asset_coverage : ''; //
	...
	$data['s_asset_audience_level'] = ! empty($row->asset_audience_level) ? $row->asset_audience_level : ''; //
	...
	$data['s_asset_audience_rating'] = ! empty($row->asset_audience_rating) ? $row->asset_audience_rating : ''; //
	...
	$data['s_asset_annotation'] = ! empty($row->asset_annotation) ? $row->asset_annotation : ''; //
	...
	$data['s_asset_rights'] = ! empty($row->asset_rights) ? $row->asset_rights : ''; //
	...
	$data['digitized'] = ($row->digitized != '') ? (int) $row->digitized : -1;
	...
	$data['s_physical_format_type'] = ! empty($row->physical_format_type) ? $row->physical_format_type : '';
	$data['physical_format_type'] = ! empty($row->physical_format_type) ? $row->physical_format_type : '';
	$data['s_physical_format_name'] = ! empty($row->physical_format_name) ? $row->physical_format_name : '';
	$data['physical_format_name'] = ! empty($row->physical_format_name) ? $row->physical_format_name : '';
	$data['s_digital_format_type'] = ! empty($row->digital_format_type) ? $row->digital_format_type : '';
	$data['digital_format_type'] = ! empty($row->digital_format_type) ? $row->digital_format_type : '';
	$data['s_digital_format_name'] = ! empty($row->digital_format_name) ? $row->digital_format_name : '';
	$data['digital_format_name'] = ! empty($row->digital_format_name) ? $row->digital_format_name : '';
