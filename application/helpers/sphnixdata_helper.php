...
function make_assets_sphnix_array($row, $new = TRUE)
{
	...
	$data['s_physical_format_type'] = ! empty($row->format_type) ? $row->physical_format_type : '';
	$data['physical_format_type'] = ! empty($row->format_type) ? $row->physical_format_type : '';
	$data['s_physical_format_name'] = ! empty($row->format_name) ? $row->physical_format_name : '';
	$data['physical_format_name'] = ! empty($row->format_name) ? $row->physical_format_name : '';
	$data['s_digital_format_type'] = ! empty($row->format_type) ? $row->digital_format_type : '';
	$data['digital_format_type'] = ! empty($row->format_type) ? $row->digital_format_type : '';
	$data['s_digital_format_name'] = ! empty($row->format_name) ? $row->digital_format_name : '';
	$data['digital_format_name'] = ! empty($row->format_name) ? $row->digital_format_name : '';
