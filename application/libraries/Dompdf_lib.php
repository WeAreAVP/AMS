...
class Dompdf_lib
{
	...
	function convert_html_to_pdf($data, $filename = 'sample.pdf', $stream = TRUE)
	{
		...
		$html = '<div style="background:url(/images/nav-back.png) transparent repeat-x;margin-top:-35px;margin-left:-40px;padding:0;width:900px;"><img src="' . base_url() . 'images/cpb_ams.png" style="width:127px;height:44px;"></div>';
