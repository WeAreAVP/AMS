...
class Dompdf_lib
{
	...
	function convert_html_to_pdf($data, $filename = 'sample.pdf', $stream = TRUE)
	{
		...
		{
			$html .='<div style="page-break-after: always;"><br/><div><h4 style="background-color:green;">Scheduled for Digitization</h4></div><br/>';
			$html .='<table style="width:100%;><thead style="font-weight:bold;"><tr style="border-bottom:2px solid black;"><td>Station Name</td><td>Nominated Assets</td><td>City</td><td>State</td></tr></thead><tbody>';
			$total = 0;
		...
		{
			$html .='<div style="page-break-after: always;"><br/><div><h4 style="background-color:green;">Materials at Crawford</h4></div><br/>';
