...
class Zend_Gdata_Analytics_DataQuery extends Zend_Gdata_Query
{
    ...
    // M0. Sessions
    const METRIC_SESSIONS = 'ga:sessions';
    const METRIC_AVG_SESSION_DURATION = 'ga:avgSessionDuration';
    const METRIC_PERCENT_NEW_SESSION = 'ga:percentNewSessions';
    const METRIC_USERS = 'ga:users';
    
    // M1. Visitor
    const METRIC_BOUNCES = 'ga:bounces';
    const METRIC_BOUNCES_RATE = 'ga:visitBounceRate';
    const METRIC_BOUNCE_RATE = 'ga:bounceRate';
    const METRIC_ENTRANCES = 'ga:entrances';
    const METRIC_EXITS = 'ga:exits';
    const METRIC_EXITS_RATE = 'ga:exitRate';
    ...
    const METRIC_PAGEVIEWS_PER_SESSION = 'ga:pageviewsPerSession';
    const METRIC_PAGEVALUE = 'ga:pageValue';
    ...
    const METRIC_GOAL_CONVERSION_RATE = 'ga:goalConversionRateAll';
    ...
    const METRIC_GOAL_1_CONVERSION = 'ga:goal1ConversionRate';
    ...
    const METRIC_AVG_EVENT_VALUE = 'ga:avgEventValue';
