	...
	function make_collection_xml($records)
	{
		...
		else
		{
			...
			foreach ($records as $asset)
			{
				...
				$this->_add_attribute($xml_object, array('xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance'),'xmlns');
//				$attributes = array(
//					'xsi:xmlns' => "http://www.w3.org/2001/XMLSchema-instance",
...
//				$this->_add_attribute($xml_object, $attributes, 'xsi');
	...
	private function _fetch_events($xml_object)
	{
		...
		$this->_add_attribute($object_guid, array('xsi:type' => 'representation'));
		...
		{
			$event_object = $this->_add_child($xml_object, 'event', 'No Event information.');
			return FALSE;
		}
	}
