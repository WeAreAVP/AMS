...
class Export_pbcore_premis
{
	...
	public function make_xml()
	{
		if ($this->asset_id !== NULL)
		{
			if ($this->is_pbcore_export)
			{
				$this->xml = new SimpleXMLElement('<?xml version="1.0" encoding="UTF-8"?><pbcoreDescriptionDocument></pbcoreDescriptionDocument>', LIBXML_NOERROR, false, 'xsi', true);
				$attributes = array(
					'xmlns' => "http://www.pbcore.org/PBCore/PBCoreNamespace.html",
					'xmlns:xsi' => "http://www.w3.org/2001/XMLSchema-instance",
					'xsi:schemaLocation' => "http://www.pbcore.org/PBCore/PBCoreNamespace.html http://www.pbcore.org/xsd/pbcore-2.0.xsd");
...
//		}
	...
	private function _add_attribute($object, array $attributes)
	{
		...
		{
			$object->addAttribute($attribute, htmlentities(@iconv('UTF-8', 'ASCII//IGNORE', $value)));
		}
		return $object;
	}
