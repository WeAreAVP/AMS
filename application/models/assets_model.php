...
class	Assets_Model	extends	CI_Model
{
				...
				function	get_asset_by_asset_id($asset_id)
				{
								$sql	=	"SELECT $this->_assets_table.id AS asset_id, 
																...
																GROUP_CONCAT(DISTINCT(IFNULL(local.identifier_source,'(**)')) SEPARATOR ' | ') AS local_identifier_source, 
																GROUP_CONCAT(DISTINCT(IFNULL(local.identifier_ref,'(**)')) SEPARATOR ' | ') AS local_identifier_ref, 
