...
class Manage_Asset_Model extends CI_Model
{
	...
	function delete_asset_types($asset_id)
	{
		...
		$this->db->delete('assets_asset_types');
	...
	function delete_asset_titles($asset_id)
	{
		$this->db->where('assets_id', $asset_id);
		$this->db->delete('asset_titles');
		return $this->db->affected_rows() > 0;
	}

	function delete_asset_subjects($asset_id)
	{
		$this->db->where('assets_id', $asset_id);
		$this->db->delete('assets_subjects');
		return $this->db->affected_rows() > 0;
	}

	function delete_asset_descriptions($asset_id)
	{
		$this->db->where('assets_id', $asset_id);
	...
	function delete_asset_coverage($asset_id)
	{
		$this->db->where('assets_id', $asset_id);
		$this->db->delete('coverages');
		return $this->db->affected_rows() > 0;
	}
	...
	function delete_creator($asset_id)
	{
		$this->db->where('assets_id', $asset_id);
	...
	function delete_publisher($asset_id)
	{
		$this->db->where('assets_id', $asset_id);
		$this->db->delete('assets_publishers_role');
		return $this->db->affected_rows() > 0;
	}
