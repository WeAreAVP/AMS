...
class Refine_modal extends CI_Model
{
	...
	{
		$this->db->select("google_refine.id,CONCAT(user_profile.first_name,' ', user_profile.last_name) AS name,google_refine.user_id,google_refine.project_id,google_refine.is_active", FALSE);
