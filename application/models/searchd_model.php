...
a_format.format_name,
 ...
 CONCAT('___',GROUP_CONCAT(DISTINCT(instantiation_formats.format_name) SEPARATOR '___ ___'),'___') AS `physical_format_name`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(d_format.format_type) SEPARATOR '___ ___'),'___') AS `digital_format_type`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(d_format.format_name) SEPARATOR '___ ___'),'___') AS `digital_format_name`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(generations.generation) SEPARATOR '___ ___'),'___') AS `facet_generation`,
...
instantiation_colors.color, 
 ...
 CONCAT('___',GROUP_CONCAT(DISTINCT(instantiation_media_types.media_type) SEPARATOR '___ ___'),'___') AS `media_type`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(instantiation_formats.format_type) SEPARATOR '___ ___'),'___') AS `physical_format_type`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(instantiation_formats.format_name) SEPARATOR '___ ___'),'___') AS `physical_format_name`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(d_format.format_name) SEPARATOR '___ ___'),'___') AS `digital_format_name`, 
 CONCAT('___',GROUP_CONCAT(DISTINCT(generations.generation) SEPARATOR '___ ___'),'___') AS `facet_generation`, 
