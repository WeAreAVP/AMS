...
CONCAT('__',GROUP_CONCAT(DISTINCT(instantiation_media_types.media_type) SEPARATOR '__'),'__') AS `media_type`, 
a_format.format_type,
a_format.format_name,
 CONCAT('__',GROUP_CONCAT(DISTINCT(instantiation_formats.format_type) SEPARATOR '__'),'__') AS `physical_format_type`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(instantiation_formats.format_name) SEPARATOR '__'),'__') AS `physical_format_name`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(d_format.format_type) SEPARATOR '__'),'__') AS `digital_format_type`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(d_format.format_name) SEPARATOR '__'),'__') AS `digital_format_name`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(generations.generation) SEPARATOR '__'),'__') AS `facet_generation`,
...
instantiation_colors.color, 
 ...
 CONCAT('__',GROUP_CONCAT(DISTINCT(instantiation_media_types.media_type) SEPARATOR '__ __'),'__') AS `media_type`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(instantiation_formats.format_type) SEPARATOR '__ __'),'__') AS `physical_format_type`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(instantiation_formats.format_name) SEPARATOR '__ __'),'__') AS `physical_format_name`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(d_format.format_type) SEPARATOR '__ __'),'__') AS `digital_format_type`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(d_format.format_name) SEPARATOR '__ __'),'__') AS `digital_format_name`, 
 CONCAT('__',GROUP_CONCAT(DISTINCT(generations.generation) SEPARATOR '__ __'),'__') AS `facet_generation`, 
