<div class="row-fluid">
    ...
    <div  class="span9">
        <div style="text-align: right;width: 860px;"><strong>1 - <?php echo $count; ?></strong> of <strong><?php echo $total; ?></strong><a class="btn"><i class="icon-chevron-left"></i></a><a class="btn"><i class="icon-chevron-right"></i></a><?php echo $this->pagination->create_links(); ?></div>
