            ...
            <div class="content" >
																...
																)
																{
																				...
																				<ul class="nav nav-tabs">
																								...
																								{
																												?>
																												<li class="<?php	echo	active_anchor('templatemanager',	array('add',	'lists',	'edit',	'details',	'readmessage',	'manage_crawford'));	?>"><a href="<?php	echo	site_url('templatemanager/lists');	?>" >Email Template</a></li>
																								<?php	}	?>
