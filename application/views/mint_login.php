...
<form id="Login" name="login" action="<?php echo $this->config->item('mint_url'); ?>/Login.action" method="post" class="athform" style="display: none;">
