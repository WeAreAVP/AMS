												...
												<div class="span12 form-row">
																...
																<div id="search_bar" class="span8">
																				<div class="disabled-field">
																								...
																								<?php	}	?>
																								<?php
																								if(isset($asset_details->title_type)	&&	$asset_details->title_type	!=	'(**)')
																								{
																												?>
																								...
																								<?php	}	?>
																								<?php
																								if(isset($asset_details->title_ref)	&&	$asset_details->title_ref	!=	'(**)')
																								{
																												?>
																								...
																								<?php	}	?>
																								<?php
																								if(isset($asset_details->title_source)	&&	$asset_details->title_source	!=	'(**)')
																								{
																												?>
...
if(isset($asset_genres)	&&	!	empty($asset_genres))
{
				...
				<?php	}	?>
												...
												<div class="span12 form-row">
																...
																<div id="search_bar" class="span8">
																								<?php
																								foreach($asset_creators_roles	as	$asset_creators_role)
																								{
																												?>
																								<div class="disabled-field">
																												<?php
								...
								<?php	}	?>
												...
												<div class="span12 form-row">
																...
																<div id="search_bar" class="span8">
																								<?php
																								foreach($asset_contributor_roles	as	$asset_contributor_role)
																								{
																												?>
																								<div class="disabled-field">
																												<?php
