  ...
  <div class="span3">
  	<div class="sidebar">
        <div class="my-navbar span12">
        	<div><a href="<?php echo site_url('records/details/'.$asset_id)?>">Asset Information</a></div>
        </div>
        <?php 
		...
		{?>
	        <div class="container-sidebar"><?php
				...
				{?>
            		<h4><a href="<?php echo site_url('instantiations/detail/'.$asset_instantiation->id)?>"><?php echo $asset_instantiation->multi_assets?></a></h4>
                    <?php 
					...
					echo ($asset_instantiation->projected_duration>0)?"Projected Duration: ".duration($asset_instantiation->projected_duration).'<br/>':'';?><?php 
				}?>
             </div>
        <?php }?>
    </div><!--end of sidebar-->
