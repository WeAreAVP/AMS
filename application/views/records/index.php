...
{ ?>class="active" <?php } ?>><a href="javascript:;" >Thumbnails</a></li>
        ...
        <div style="overflow: auto;width:865px;display:<?php if ($current_tab == 'simple')
                {
                    echo 'block';
                } else
                {
            ...
            <table class="tablesorter table table-bordered" id="simple_view_table"><?php
...
?>
        ...
        <div style="display:<?php if ($current_tab == 'full_table')
{
    echo 'block';
} else
{
    ...
    foreach ($records as $asset)
    {
        ...
        ?>
                            ...
                            ?>
                                ...
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_title_source); ?>
                                </td>
                                <td><p style="width:200px"><?php
                            if ($asset_description)
                            {
        ...
        ?>
                                ...
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_subject); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_subject_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_subject_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_genre); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_genre_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_genre_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_creator_name); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_creator_affiliation); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_creator_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_creator_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_creator_role); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_creator_role_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_name); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_affiliation); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_role); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_role_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_contributor_role_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_publisher_name); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_publisher_affiliation); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_publisher_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_publisher_role); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_publisher_role_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_publisher_role_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_date); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_date_type); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_coverage); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_coverage_type); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_audience_level); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_audience_level_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_audience_level_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_audience_rating); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_audience_rating_source); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_audience_rating_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_annotation); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_annotation_type); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_annotation_ref); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_rights); ?>
                                </td>
                                <td><?php echo str_replace("(**)", "N/A", $asset->asset_rights_link); ?>
                                </td>
                            </tr><?php }
    ?>
                    </tbody>
