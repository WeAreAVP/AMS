...
if(	!	$isAjax)
{
				...
				<div class="row-fluid">
				<?php	}	?>
				<div class="span3" style="width: 230px;overflow-y: scroll;overflow-x: hidden;">

								<?php	$this->load->view('instantiations/_facet_search');	?>
				</div>

								<div  class="span10" id="data_container" style="margin-left: 10px;">
																				...
																				<table class="table table-bordered" id="assets_table" style="border-collapse:collapse;">
																								<thead>
																												<tr style="background: rgb(235, 235, 235);">
																																<td><span style="float:left;min-width:30px;max-width:30px;"><i class="icon-flag "></i></span></td>
																																...
																																<th><span style="float:left;min-width:350px;max-width:350px;">Description</span></th>
																												</tr>
																								</thead>
																								<tbody>
																												<?php
