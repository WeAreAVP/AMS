...
$display = "<table width='950px' border='0' cellspacing='0' cellpadding='5' bgcolor='#e3cda4'>
      <tr>
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='0' align='center'>
            ...
            <tr>
              ...
              <td width='100%' align='right'><img src='$account_logo_url' align='left' /><font face='Arial, Verdana, Trebuchet MS' size='2' color='#2f343b'>
                <br><strong>" . strtoupper($property_neighborhood) . ":  </strong> {$property_beds} BED | {$property_baths} BATH | \${$property_rent}
                </font></td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='10'>
            <tr>
              <td>&nbsp;&nbsp&nbsp</td>
              <td width='60%'><a href='#'><img src='{$property_primary_image_url}' width='100%' height='360' border='0'></a></td>
              <td width='40%'><a href='#'><img src='{$property_map_url}' width='100%' height='360' border='0'></a></td>
            </tr>
          </table>
        </td>
      </tr>
      <tr>
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='10' bgcolor='#7e827a'>
            <tr>
              <td  bgcolor='#e3cda4'>&nbsp&nbsp&nbsp</td>
              <td><table width='100%' cellspacing='0' cellpadding='0' border='0' align='left'><tr>
              <td>&nbsp&nbsp&nbsp</td>
              <td width='100%' valign='top'><font face='Arial, Verdana, Trebuchet MS' size='2' color='white'>{$description} [<a href='{$property_inquiry_url}'>More Details...</a>]</font>
              </td>
            </tr>
          </table>
        </td>
        <td width='40%' valign='top' align='left'>
          <table width='100%' border='0' align='right' valign='top' cellpadding='0' cellspacing='0'>
           ";
      ...
      <tr>
        <td>
          <table width='100%' border='0' cellspacing='0' cellpadding='0'>
            <tr>
              <td></td>
              <td bgcolor='#2f343b' ><font color='red' face='Arial, Verdana, Trebuchet MS' size='3' ><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Pictures</strong></font></td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <table width='98%' border='0' cellspacing='0' cellpadding='0'>
      <tr>
        ...
        <td width='60%' valign='top'>
          <table width='100%' border='0' cellspacing='0' cellpadding='0'>
            <tr>
              <td colspan='3' bgcolor='#2f343b' ><font color='red' face='Arial, Verdana, Trebuchet MS' size='3'><strong>&nbsp&nbsp&nbspEssentials</strong></font></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><font face='Arial, Verdana, Trebuchet MS' size='2' color='olive'><strong>ID#: {$property_id}</strong></font></td>
            </tr>
          </table>
        </td>
        <td width='40%' valign='top'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
          <tr>
            <td colspan='2' bgcolor='#2f343b'><font face='Arial, Verdana, Trebuchet MS' size='3' color='red'><strong>&nbsp;&nbsp;&nbsp;Schedule a Showing</strong></font></td>
          </tr>
          <tr>
