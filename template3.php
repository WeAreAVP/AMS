...
$display = '';
$display .= "<table width='950px' border='0' cellspacing='0' cellpadding='5' bgcolor='#ffffff'>
      <tr>
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='0'>
            <tr>
              <td width='2%'>&nbsp</td>
              <td>
                <table width='100%' border='0' cellspacing='0' cellpadding='0' style='border-top:1px solid #00ACEC'>
                  <tr><td>&nbsp</td></tr>
                </table>
              </td>
            </tr>
        ...
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='0' align='center'>
            ...
            <tr>
              ...
              <td width='100%' align='right'><img src='$account_logo_url' align='left' /><font face='Arial, Verdana, Trebuchet MS' size='2' color='#00ACEC' valign='top' height='70'>
                <br>
                <strong style='line-height:30px'>" . strtoupper($property_neighborhood) . " </strong> {$property_beds} BED | {$property_baths} BATH | \${$property_rent}
        ...
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='0'>
            <tr>
              <td width='2%'>&nbsp</td>
              <td>
                <table width='100%' border='0' cellspacing='0' cellpadding='0' style='border-top:1px dotted #00ACEC'>
                  <tr><td>&nbsp</td></tr>
                </table>
              </td>
            </tr>
      ...
      <tr>
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='10'>
            <tr>
              <td>&nbsp&nbsp&nbsp</td>
              <td width='40%'><a href='#'><img src='{$property_primary_image_url}' width='100%' height='360' border='0'></a></td>
              <td width='60%'><a href='#'><img src='{$property_map_url}' width='100%' height='360' border='0'></a></td>
      ...
      <tr>
        <td>
          <table width='98%' border='0' cellspacing='0' cellpadding='0' bgcolor='#ffffff'>
            <tr>
              <td  bgcolor='#ffffff'>&nbsp&nbsp&nbsp</td>
